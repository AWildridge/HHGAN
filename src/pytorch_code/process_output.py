...
names = np.array([name[:-2] + 'h' if len(name) >= 3 else '0h' for name in names]) # only grab thousands prefix: 90000 -> 90k
...
if plotting_epochs is None:
    plot_data_idxs = [names.tolist().index(str(epochs[len(gen_datas) - 1]) + 'h'), names.tolist().index(str(epochs[int(len(gen_datas) / 2)]) + 'h'), names.tolist().index(str(epochs[4]) + 'h')]
else:
...
gr_pts_ks.GetXaxis().SetTitle('Epoch # (x100)')
...
gr_pts_ks.Draw("AL")
gr_etas_ks.Draw("L SAME")
gr_phis_ks.Draw("L SAME")
gr_masses_ks.Draw("L SAME")
gr_btags_ks.Draw("L SAME")
...
gr_pxs_ks.GetXaxis().SetTitle('Epoch # (x100)')
...
gr_pxs_ks.Draw("AL")
gr_pys_ks.Draw("L SAME")
gr_pzs_ks.Draw("L SAME")
pxyz_legend.Draw()
c_pxyz.SetLogy(True)
...
gr_dr12_ks.GetXaxis().SetTitle('Epoch # (x100)')
...
gr_dr12_ks.Draw("AL")
gr_dr13_ks.Draw("L SAME")
gr_dr14_ks.Draw("L SAME")
gr_dr15_ks.Draw("L SAME")
gr_dr23_ks.Draw("L SAME")
gr_dr24_ks.Draw("L SAME")
gr_dr25_ks.Draw("L SAME")
gr_dr34_ks.Draw("L SAME")
gr_dr35_ks.Draw("L SAME")
gr_dr45_ks.Draw("L SAME")
drs_legend.Draw()
c_drs.SetLogy(True)
...
gr_higgs_dr_ks.GetXaxis().SetTitle('Epoch # (x100)')
...
gr_higgs_dr_ks.Draw("AL")
gr_lead_m_ks.Draw("L SAME")
gr_subl_m_ks.Draw("L SAME")
gr_lead_pt_ks.Draw("L SAME")
gr_subl_pt_ks.Draw("L SAME")
gr_HH_m_ks.Draw("L SAME")
gr_HH_eta_ks.Draw("L SAME")
higgs_legend.Draw()
